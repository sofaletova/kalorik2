  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={openHow}
      >
        <Icon name="info" size={16} /> Как мы считаем
      </button>
      ...
      <div style={{ marginTop: "auto" }}>
        ...
        >
          <Icon name="refresh" size={14} /> Пройти онбординг заново
        </button>
      </div>
    </aside>
  );
    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
      ...
      <main
        ...
        style={{
          ...
          padding: isChat ? "28px 32px" : "32px 36px 48px",
      ...
      >
        <Routes>
          ...
          <Route path="/shopping" element={<Navigate to="/plan" replace />} />
          <Route path="/recommend" element={<Navigate to="/chat" replace />} />
          <Route path="/recommend/recipe" element={<Navigate to="/chat" replace />} />
